...
<!--            </div>-->
<!--        </div>-->
    <h3 class="brand-heading"> <strong> Jobs & Careers Newsletter - <span id="newsletter-date"></span> </strong> </h3> `;
...
window.onload = function () {
    ...
    let emailDiv = document.getElementById('newsletter');
    ...
    // Get today's date and set it in the element with id "todays-date"
    const todaysDate = getTodaysDate();
    document.getElementById('newsletter-date').textContent = todaysDate;
}
